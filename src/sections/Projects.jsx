    ...
    <>
      <main className="bg-sec w-full h-full">
        <div className="bg-gradient-to-t from-black from-5% via-transparent via-80% to-black to-95% w-full h-full items-center flex flex-col py-10 overflow-x-scroll hide-scrollbar">
          ...
          <div className="relative overflow-x-scroll flex items-center justify-center h-full w-max 
          lg:w-[80%] lg:left-0 left-[500px] ">
            <div className="flex gap-x-10 gap-y-5  lg:items-center items-end lg:justify-center justify-start min-w-[100%] lg:w-[60%] lg:h-[90%] h-full lg:flex-wrap sm:flex-wrap overflow-x-scroll overflow-y-hidden hide-scrollbar">
